...
> （ボトルネックが「コード生成」から「コードレビュー」へとあまりに速く移行してしまい、正直少し戸惑っている。現在のどのシステムや規範も、まだこの世界に向けて準備できていない）
> — [Logan Kilpatrick](https://x.com/OfficialLoganK/status/2033723413387219402)
